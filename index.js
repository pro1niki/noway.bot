...
client.on("interactionCreate", async (interaction) => {
    ...
    > *Por meio desse chat será feito o suporte por parte da equipe para lhe ajudar quanto a criação deste ticket. Fique atento aos horários de atendimento.*`)
                        ...
                        .setColor('#2f3136')
                        .setFooter({text:`Cidade™ Noway ©️ Todos os direitos reservados.`, iconURL: 'https://media.discordapp.net/attachments/894619714435821578/1030243003383685140/logo-gif.gif'})
                    ],
                });   
            }).catch((err) => {
                console.log(err)
            ...
            const canal = await interaction.guild.channels.create(`💳-${interaction.member.user.username}`, {
                ...
                msg.send({
                    ...
                    embeds: [
                        ...
                        .addField(`💸 Métodos de Pagamento.`, `  ➥ Mercado Pago (\`Noway.Adicionar\`)\n  ➥ PayPal (\`C. Credito\`)\n  ➥ PicPay (\`Noway.Adicionar\`)`, true)
